...
```sh
pip install dist/nomad-plugin-mbe-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Leonardo Musini | [leonardo.musini@gmail.col.com](mailto:leonardo.musini@gmail.col.com)
